    ...
    <div class="set_pass">
        <div class="set_passContent">
            ...
            <form>
                ...
                <input type="password" placeholder="Confirm Password.." v-model="confirm_pass">
...
export default {
    ...
    methods: {
        async submit() {
            ...
            if ((this.new_pass !== '' && this.confirm_pass !== '') && this.new_pass == this.confirm_pass) {
                this.error_newPass = '';
                this.error_confirmPass = '';

                const response = await axios.post(`https://uatapi.magaswala.com/public/api/forgotchangepassword/${this.id}?new_password=${this.new_pass}&confirm_password=${this.confirm_pass}`).catch((e) => e.response);
