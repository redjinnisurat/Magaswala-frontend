        ...
        <div class="loginContent">
            ...
            <form>
                ...
                <div class="password_input">
                    <input type="password" placeholder="Password" ref="pass_input" v-model="password">
                    <i v-if="visible" class="fa-regular fa-eye" v-on:click="visibleNo()"></i>
                    <i v-else class="fa-regular fa-eye-slash" v-on:click="visibleYes()"></i>
                </div>
                ...
                <div class="radio">
                    <div class="radioInput">
                        ...
                        <div class="radio_img" id="remember" v-on:click="rememberMe()">
                            <img src="./assets/check_mark.png" :class="{visibility: show}" alt="img">
                        </div>
                    </div>
    ...
    methods: {
        ...
        async login() {
            ...
            if (this.email !== '' && this.password !== '') {
                ...
                const response = await axios.post(`https://uatapi.magaswala.com/public/api/login?email=${this.email}&password=${this.password}`).catch((e) => e.response);
