<template>
    ...
    <div>
        ...
        <button type="button" id="btn"><span style="text-align: justify;">Add to bag</span></button>
...
<h5>&emsp;&emsp;&emsp;&emsp;Know about us</h5><br>
    ...
    <div class="row">
    <div class="col-5">
    <img id="know" src="../assets/image/know.png" /></div>
    <div class="col">
    <p class="a"><b>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut 
        labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea
         ...
         consetetur sadipscing elitr, sed diam nonumy.</b></p>
    </div>
    </div>
    </div><br>
    <br>
    <div class="row"><h5>&emsp;&emsp;&emsp;&ensp; User Review</h5></div>
    <br>
    <div class="container-xl">
        <div class="row">
            <div class="col" id="review">
                <img id="profile" src="../assets/image/profile.png"><br>
                <br>
